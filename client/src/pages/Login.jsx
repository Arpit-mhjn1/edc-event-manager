  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl z-10 border border-gray-100">
        <div>
          <div className="w-16 h-16 mx-auto bg-gradient-to-tr from-primary-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg mb-6 text-white font-bold text-2xl">
            EDC
          </div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in to the Entrepreneurship Development Cell Portal
          </p>
        </div>
